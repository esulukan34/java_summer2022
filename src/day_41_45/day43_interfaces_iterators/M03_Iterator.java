...
public class M03_Iterator {
    public static void main(String[] args) {
        ...
        for (Integer each : liste) {
            each += 3;
            System.out.print(each + " "); // 13 23 33 artmis oldu
        }

        System.out.println("");
        System.out.println(liste); // [10, 20, 30] degismedi eski hali geldi
        ...
        while (it3.hasNext()) { // yaninda elemanı oldugu muddetce devam ettir
            it3.next();
            it3.remove();
        }
        ...
        it4.next();
        it4.remove();
        System.out.println("son liste " + liste);

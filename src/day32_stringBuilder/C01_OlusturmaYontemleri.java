...
public class C01_OlusturmaYontemleri {
    public static void main(String[] args) {
        // 3 farkli sekilde StringBuilder olusturalim
        ...
        sb1.append("Candir");
        System.out.println("sb1.length() = " + sb1.length()); // 10
        System.out.println("sb1.capacity() = " + sb1.capacity()); // 16

        sb1.append(", gerisi heyecandir!");
        System.out.println("sb1.length() = " + sb1.length()); // 30
